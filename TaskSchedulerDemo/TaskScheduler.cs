    ...
    public class TaskScheduler
    {
        ...
        public class TriggerSettingsOneTimeOnly
        {
            ...
            public string XMLDate
            {
                ...
                set {
                    this.Date = DateTime.ParseExact(value, "yyyy-MM-dd", null).Date;
                }
            }
        ...
        public class TriggerItem
        {
            ...
            public string XMLStartDate
            {
                ...
                set {
                    this.StartDate = DateTime.ParseExact(value, "yyyy-MM-dd", null);
                }
            }
            ...
            public string XMLEndDate
            {
                ...
                set {
                    this.EndDate = DateTime.ParseExact(value, "yyyy-MM-dd", null);
                }
            }
            ...
            {
                get {
                    return this.TriggerTime.ToString("HH:mm:ss");    //yyyy-MM-dd
                }
                set {
                    this.TriggerTime = DateTime.ParseExact(value, "HH:mm:ss", null);
                }
            }
